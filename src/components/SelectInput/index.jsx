...
export default function SelectInput({genres, setGenres}) {

    return (
        <Select.Root onValueChange={setGenres}>
            <Select.Trigger className={"inline-flex h-10 w-full items-center justify-between  gap-1 bg-gray-100 p-4 text-[13px] leading-none text-ink border border-gray-300"} aria-label="Gêneros do filme"> 
            ...
            <Select.Portal>
            <Select.Content className="rounded-md bg-gray-100 border-gray-300 shadow-[0px_10px_38px_-10px_rgba(22,23,24,0.35),0px_10px_20px_-15px_rgba(22,23,24,0.2)]">
